<template>
  <div class="scroll-smooth">
    <div id="home">
      <main class="lg:mt-48 md:mt-48 sm:mt-36 mt-36">
        <div
          class="lg:flex md:flex sm:block block justify-around items-center px-10"
        >
    ...
    <div class="mt-40" id="skill">
      <Skill />
    </div>
    <div class="mt-40" id="education">
      <Education />
    </div>
